...
**Task 3 — Step 1 complete (9 test files), Step 2 RED complete. Step 3 Stage A (compatibility/analyzer) complete; Step 3 Stage B (clock callsite migration) next. Task 3 Step 3 overall remains in progress/unchecked.**
