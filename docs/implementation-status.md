...
| 4 | in progress | OpenCode unavailable; approved headless fallback unavailable; host fallback under contract | pre-review green; post-review pending | pending | Implementation checkpoint green: focused 24/24, expanded a11y/shell/Today 29/29, analyzer clean, full 188/188; no device/emulator |
