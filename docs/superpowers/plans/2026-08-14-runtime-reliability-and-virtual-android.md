...
- [x] **Step 4: HANDOFF** — include only the workflow, direct dependency/lock classification, parsed contract test, plan, and status; exclude the user-owned `.mcp.json`; commit and push this bounded checkpoint.
  ```bash
